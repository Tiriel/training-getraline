 ...
 */
final class Version20240620102613 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (id, email, password, roles, channel) SELECT id, email, password, roles, channel FROM __temp__user');
